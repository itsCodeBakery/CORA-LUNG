# ==========================================================================================
# COVA-3D — BLOCK 10C-FACTORIAL-BATCH-11-PRED-FREEZE
#
# BATCH
# -----
# fold3_seed29
...
TEST_PATH = (
    REPO
    / "tests/"
    "test_cova3d_factorial_batch11_prediction_freeze.py"
)

SOURCE_PATH = (
    REPO
    / "scripts/code_blocks/"
    "block10c_factorial_batch11_prediction_freeze.py"
)
...
def make_git_auth():
    ...
    askpass = Path(
        "/tmp/cova3d_git_askpass_batch11_predictions.sh"
    )
...
heading(
    "COVA-3D 10C — BATCH-11 IMAGE-ONLY PREDICTION FREEZE"
)
...
if state.get(
    ...
    raise RuntimeError(
        "Batch-11 fit is not the latest completed block."
    )
...
if state.get(
    ...
    raise RuntimeError(
        "Batch-11 fit status is not COMPLETE."
    )
...
if len(
    ...
    raise RuntimeError(
        "Expected six Batch-11 fit rows."
    )
...
if set(
    ...
    raise RuntimeError(
        "Unexpected Batch-11 condition set."
    )
...
if len(
    ...
    raise RuntimeError(
        "Execution registry does not contain six Batch-11 runs."
    )
...
if int(
    ...
    raise RuntimeError(
        "Could not identify six Batch-11 execution rows."
    )
...
if int(
    ...
    raise RuntimeError(
        "Could not identify Batch-11 registry row."
    )
...
state[
    ...
    "FACTORIAL_BATCH11_PREDICTIONS_FROZEN_BATCH12_PENDING"
)
...
state[
    "factorial_batch11_prediction_status"
] = (
    "FROZEN"
)

state[
    "factorial_batch11_prediction_manifest"
] = str(
...
state[
    ...
    "Train the six frozen factorial conditions for fold3_seed43. "
...
project_state[
    ...
    "cova3d_factorial_batch12_pending"
)
...
print(
    "✓ Batch-11 execution status            : PREDICTIONS_FROZEN"
)

print(
    "✓ Prediction-frozen runs               : 36 /72"
)

print(
    "✓ Frozen probability maps              : 144"
)
...
if tests.returncode != 0:
    ...
    raise RuntimeError(
        "Batch-11 prediction-freeze regression tests failed."
    )
...
git(
    "commit",
    "-m",
    "experiment: freeze COVA-3D factorial batch 11 predictions [parallel]",
)
...
heading(
    "COVA-3D 10C — BATCH-11 PREDICTION FREEZE FINAL REPORT"
)
...
print(
    "BATCH-11 IMAGE-ONLY PREDICTIONS"
)
...
print(
    "Fits represented on branch             : 36 /72"
)

print(
    "Prediction-frozen runs on branch       : 36 /72"
)

print(
    "Frozen probability maps on branch      : 144"
)
...
print()
print(
    "STATUS                                 : BATCH11_PREDICTIONS_SAFELY_FROZEN"
)
...
print(
    "After I audit this result, Batch 07 will be backed up. Next scientific batch is fold3_seed43."
)
