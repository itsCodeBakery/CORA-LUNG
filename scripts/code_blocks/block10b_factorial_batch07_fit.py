# ==========================================================================================
# COVA-3D — BLOCK 10B-FACTORIAL-BATCH-07
#
...
FIG_PNG = (
    REPO
    / "figures/audit/"
    "fig_cova3d_factorial_batch07_training_curves.png"
)

FIG_PDF = (
    REPO
    / "figures/audit/"
    "fig_cova3d_factorial_batch07_training_curves.pdf"
)

TEST_PATH = (
    REPO
    / "tests/"
    "test_cova3d_factorial_batch07_fit.py"
)

SOURCE_PATH = (
    REPO
    / "scripts/code_blocks/"
    "block10b_factorial_batch07_fit.py"
)
...
def make_git_auth():
    ...
    askpass = Path(
        "/tmp/cova3d_git_askpass_batch07.sh"
    )
...
heading(
    "COVA-3D 10B-FACTORIAL-BATCH-07 — PREFLIGHT"
)
...
if state.get(
    ...
    raise RuntimeError(
        "Unexpected frozen main-line state for parallel Batch-07 execution."
    )


if BATCH_ID != "fold2_seed17":

    raise RuntimeError(
        "Parallel Batch-07 authorization mismatch."
    )
...
if len(
    ...
    raise RuntimeError(
        "Batch-07 does not contain six runs."
    )
...
state[
    ...
    "FACTORIAL_BATCH07_FIT_COMPLETE_PREDICTION_FREEZE_PENDING"
)
...
state[
    "factorial_batch07_outer_fold"
] = (
    OUTER_FOLD
)

state[
    "factorial_batch07_seed"
] = (
    SEED
)

state[
    "factorial_batch07_models"
] = (
    6
)

state[
    "factorial_batch07_shared_initialization_sha256"
] = (
    initialization_sha
)

state[
    "factorial_batch07_paired_plan_sha256"
] = (
    paired_plan_sha
)
...
state[
    ...
    "Batch-07 models before moving to fold2_seed29."
)
...
project_state[
    ...
    "cova3d_factorial_batch07_prediction_freeze_pending"
)
...
project_state[
    ...
    "Run 10C-FACTORIAL-BATCH-07-PRED-FREEZE."
)
...
tests = sh(
    [
        ...
        "tests/test_cova3d_factorial_batch07_fit.py",
...
if tests.returncode != 0:
    ...
    raise RuntimeError(
        "Batch-07 regression tests failed."
    )
...
git(
    "commit",
    "-m",
    "experiment: reconstruct COVA-3D factorial batch 07 fits after runtime loss",
)
...
print(
    "Recovery mode: GitHub push deferred until exact checkpoint-hash audit."
)
...
if final_status:
    ...
    raise RuntimeError(
        "Repository not clean after Batch-07 commit:\n"
        + final_status
    )
...
heading(
    "COVA-3D 10B-FACTORIAL-BATCH-07 — FINAL REPORT"
)
...
print(
    "GitHub synchronization                 : DEFERRED_FOR_HASH_AUDIT"
)
...
print(
    ...
    "for each model before this parallel Batch-07 run is backed up."
)
